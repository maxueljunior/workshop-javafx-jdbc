...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		ValidationException exception = new ValidationException("Validação error");
	...
	public void updateFormData() {
		...
		if (entity == null) {
			throw new IllegalStateException("Entity está nullo");
		}
	...
	public void loadAssociatedObjects() {
		...
		if (departmentService == null) {
			throw new IllegalStateException("DepartmentService as null");
		} else {
